...
tagger = Classifier("training.arff")
tagger.train()
...
testingValues = dataset[:,:11]
testingClasses = dataset[:,11]
...
table = [["", "SURNAME", "FORENAME", "OCCUPATION", "ADDRESS"],
         ["Precision", scores["SURNAME"]["Precision"], scores["FORENAME"]["Precision"],
          scores["OCCUPATION"]["Precision"], scores["ADDRESS"]["Precision"]],
         ["Recall", scores["SURNAME"]["Recall"], scores["FORENAME"]["Recall"],
          scores["OCCUPATION"]["Recall"], scores["ADDRESS"]["Recall"]],
         ["F-score", scores["SURNAME"]["F-score"], scores["FORENAME"]["F-score"],
          scores["OCCUPATION"]["F-score"], scores["ADDRESS"]["F-score"]]]
